...
export const OpMap = {
    ...
    [Op.between]:(key:string, value:any):SqlBind => {
        if(!Array.isArray(value)){throw new Error('between need Array')}
    ...
    [Op.in]:(key:string, value:any):SqlBind => {
        if(!Array.isArray(value)){throw new Error('IN need Array')}
    ...
    [Op.notIn]:(key:string, value:any):SqlBind => {
        if(!Array.isArray(value)){throw new Error('NOT IN need Array')}
